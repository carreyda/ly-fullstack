import type { PaginationParams, PaginationResult } from '@repo/shared/types';

import type { DataFilterModel } from '@/types';

const DEFAULT_PAGE_NUM = 1;

type PaginationFilters = PaginationParams & DataFilterModel;

interface UsePaginationOptions<TFilters extends PaginationFilters> {
  /**
 ...
 * 管理后台分页列表通用状态
 *
 * Hook 统一管理筛选参数、页码、列表、Loading 和请求竞态；具体接口函数由页面传入，避免分页能力
