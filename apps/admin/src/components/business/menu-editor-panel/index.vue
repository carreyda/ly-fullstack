...
import MenuIconPicker from '@/components/business/menu-icon-picker/index.vue';
import { ADMIN_PAGE_OPTIONS } from '@/constants';

import type { FormRules } from 'element-plus';
import type { AdminMenuTreeNode, PermissionCode, RbacMenuType } from '@repo/shared/types';
import type { AdminMenuEditorModel } from '@/types';
...
/**
 * Element Plus Form 暴露的最小校验能力
 */
interface MenuFormExpose {
  /**
   * 执行当前表单的全部校验规则
   */
